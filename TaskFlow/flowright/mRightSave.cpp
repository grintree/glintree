...
MRightSave::MRightSave(QWidget *parent) : QWidget(parent)
{
    ...
    connect(saveBtn,&QPushButton::clicked,this,[this,saveBtn](bool clicked){
        ...
        saveBtn->setStyleSheet(".QPushButton {color:white;font-family:SimSun;font-size:17px;background-color:rgb(208,208,208);border-style: solid;border-width: 0px; border-radius: 3px;padding: 2px;}");
