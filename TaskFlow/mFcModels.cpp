...
MFlowStepParamsCaptcha::MFlowStepParamsCaptcha(const QString &program){
    QStringList params = program.split(SEPARATOR_1);
    if(params.length() == 8){
        name = QString(QByteArray::fromBase64(params[0].toUtf8().data()));
        stepURL = QString(QByteArray::fromBase64(params[1].toUtf8().data()));
        stepID = QString(QByteArray::fromBase64(params[2].toUtf8().data()));
        menuType = QString(QByteArray::fromBase64(params[3].toUtf8().data()));
        eleXpath = QString(QByteArray::fromBase64(params[4].toUtf8().data()));
        inputXpath = QString(QByteArray::fromBase64(params[5].toUtf8().data()));
        waitSleep = QString(QByteArray::fromBase64(params[6].toUtf8().data())).toInt();
        isLoop = QString(QByteArray::fromBase64(params[7].toUtf8().data())).toInt();
    }else if(params.length() == 4){//兼容旧版本（仅名称/网址/ID/类型）
        name = QString(QByteArray::fromBase64(params[0].toUtf8().data()));
        stepURL = QString(QByteArray::fromBase64(params[1].toUtf8().data()));
        stepID = QString(QByteArray::fromBase64(params[2].toUtf8().data()));
        menuType = QString(QByteArray::fromBase64(params[3].toUtf8().data()));
    }else {
        QLOG_INFO()<<"MFlowStepParamsCaptcha(const QString &program) 反序列化失败";
    }
}
...
MFlowStepParamsSwitch::MFlowStepParamsSwitch(const QString &program){
    ...
    if(params.length() == 10){
        ...
        waitEmergintEle = QString(QByteArray::fromBase64(params[7].toUtf8().data()));
        isLoop = QString(QByteArray::fromBase64(params[8].toUtf8().data())).toInt();
        switchValue = QString(QByteArray::fromBase64(params[9].toUtf8().data()));
    }else if(params.length() == 9){//兼容旧版本
        name = QString(QByteArray::fromBase64(params[0].toUtf8().data()));
        stepID = QString(QByteArray::fromBase64(params[1].toUtf8().data()));
        stepURL = QString(QByteArray::fromBase64(params[2].toUtf8().data()));
        menuType = QString(QByteArray::fromBase64(params[3].toUtf8().data()));
...
MFlowStepParamsIf::MFlowStepParamsIf(const QString &program){
    ...
    if(params.length() == 10){
        ...
        waitEmergintEle = QString(QByteArray::fromBase64(params[5].toUtf8().data()));
        isLoop = QString(QByteArray::fromBase64(params[6].toUtf8().data())).toInt();
        judgeType = QString(QByteArray::fromBase64(params[7].toUtf8().data()));
        eleXpath = QString(QByteArray::fromBase64(params[8].toUtf8().data()));
        judgeValue = QString(QByteArray::fromBase64(params[9].toUtf8().data()));
    }else if(params.length() == 7){//兼容旧版本
        name = QString(QByteArray::fromBase64(params[0].toUtf8().data()));
        stepID = QString(QByteArray::fromBase64(params[1].toUtf8().data()));
        stepURL = QString(QByteArray::fromBase64(params[2].toUtf8().data()));
        menuType = QString(QByteArray::fromBase64(params[3].toUtf8().data()));
        ...
        QLOG_INFO()<<"MFlowStepParamsIf(const QString &program) 反序列化失败";
    }
}
const QString MFlowStepParamsIf::getProgram(){
    ...
    params<<name.toUtf8().toBase64()
          ...
          <<waitEmergintEle.toUtf8().toBase64()
          <<QString::number(isLoop).toUtf8().toBase64()
          <<judgeType.toUtf8().toBase64()
          <<eleXpath.toUtf8().toBase64()
          <<judgeValue.toUtf8().toBase64();
...
MFlowStepParamsEndLoop::MFlowStepParamsEndLoop(const QString &program){
    QStringList params = program.split(SEPARATOR_1);
    if(params.length() == 4){
        name = QString(QByteArray::fromBase64(params[0].toUtf8().data()));
        stepURL = QString(QByteArray::fromBase64(params[1].toUtf8().data()));
        ...
        QLOG_INFO()<<"MFlowStepParamsEndLoop(const QString &program) 反序列化失败";
    }
}
...
MFlowStepParamsEnd::MFlowStepParamsEnd(const QString &program){
    QStringList params = program.split(SEPARATOR_1);
    if(params.length() == 4){
        name = QString(QByteArray::fromBase64(params[0].toUtf8().data()));
        stepURL = QString(QByteArray::fromBase64(params[1].toUtf8().data()));
        ...
        QLOG_INFO()<<"MFlowStepParamsEnd(const QString &program) 反序列化失败";
    }
}
