...
void About::initTopUi(){
    ...
    outWidget->setStyleSheet(".QWidget{background-color:rgb(209,209,214);border-radius: 5px;}");
...
void About::initSoftwareUi(){
    ...
    thridLabel->setText(tr("特别感谢 <a style='text-decoration:none;color:rgb(0,106,224);' href='https://www.chromium.org'>Chromium</a>, <a style='text-decoration:none;color:rgb(0,106,224);' href='https://www.qt.io'>Qt</a>"));
    ...
    osAddressBtn->setStyleSheet("QToolButton{border:0px;font-family:Microsoft YaHei;font-size:17px;color:rgb(0,106,224)}");
    ...
    osHLayout->addSpacing(20);

    // 更新说明入口（帮助 -> 关于）
    QToolButton *updateBtn = new QToolButton(osWidget);
    updateBtn->setCursor(Qt::PointingHandCursor);
    updateBtn->setStyleSheet("QToolButton{border:0px;font-family:Microsoft YaHei UI;font-size:17px;color:rgb(10,132,255)}");
    updateBtn->setText("查看更新说明");
    connect(updateBtn,&QToolButton::clicked,this,[](){
        Utils::openUpdateSummary();
    });
    osHLayout->addWidget(updateBtn);
