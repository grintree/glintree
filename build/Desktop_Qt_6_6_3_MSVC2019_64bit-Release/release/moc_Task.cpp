...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTaskENDCLASS_t qt_meta_stringdata_CLASSTaskENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 19),  // "notifyChangeTabName"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 4),  // "name"
        QT_MOC_LITERAL(31, 19),  // "notifyChangeTabIcon"
        QT_MOC_LITERAL(51, 4)   // "icon"
    },
    "Task",
    "notifyChangeTabName",
    "",
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Task::notifyChangeTabName; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Task::*)(const QIcon & );
            if (_t _q_method = &Task::notifyChangeTabIcon; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
