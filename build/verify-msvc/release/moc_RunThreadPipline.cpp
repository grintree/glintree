...
namespace {
struct qt_meta_tag_ZN16RunThreadPiplineE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16RunThreadPiplineE = QtMocHelpers::stringData(
    "RunThreadPipline",
    "notifyUpdateData",
    "",
    "num",
...
Q_CONSTINIT static const uint qt_meta_data_ZN16RunThreadPiplineE[] = {
...
Q_CONSTINIT const QMetaObject RunThreadPipline::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16RunThreadPiplineE.offsetsAndSizes,
    qt_meta_data_ZN16RunThreadPiplineE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16RunThreadPiplineE_t,
        // Q_OBJECT / Q_GADGET
...
void RunThreadPipline::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (RunThreadPipline::*)(int , QStringList , QStringList );
            if (_q_method_type _q_method = &RunThreadPipline::notifyUpdateData; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (RunThreadPipline::*)(int , QString );
            if (_q_method_type _q_method = &RunThreadPipline::notifyAlert; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (RunThreadPipline::*)();
            if (_q_method_type _q_method = &RunThreadPipline::notifyJobFinished; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *RunThreadPipline::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16RunThreadPiplineE.stringdata0))
