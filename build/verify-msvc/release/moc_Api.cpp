...
static constexpr auto qt_meta_stringdata_ZN3ApiE = QtMocHelpers::stringData(
    "Api"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN3ApiE[] = {
...
Q_CONSTINIT const QMetaObject Api::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN3ApiE.offsetsAndSizes,
    qt_meta_data_ZN3ApiE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN3ApiE_t,
        // Q_OBJECT / Q_GADGET
...
void *Api::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN3ApiE.stringdata0))
