...
static constexpr auto qt_meta_stringdata_ZN13VersionDialogE = QtMocHelpers::stringData(
    "VersionDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13VersionDialogE[] = {
...
Q_CONSTINIT const QMetaObject VersionDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13VersionDialogE.offsetsAndSizes,
    qt_meta_data_ZN13VersionDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13VersionDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *VersionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13VersionDialogE.stringdata0))
