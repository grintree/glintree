...
namespace {
struct qt_meta_tag_ZN20MFlowRightLoopWidgetE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN20MFlowRightLoopWidgetE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20MFlowRightLoopWidgetE[] = {
...
Q_CONSTINIT const QMetaObject MFlowRightLoopWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20MFlowRightLoopWidgetE.offsetsAndSizes,
    qt_meta_data_ZN20MFlowRightLoopWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20MFlowRightLoopWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *MFlowRightLoopWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20MFlowRightLoopWidgetE.stringdata0))
