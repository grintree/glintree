...
namespace {
struct qt_meta_tag_ZN28MCustomTaskSmartAlertSuccessE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN28MCustomTaskSmartAlertSuccessE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN28MCustomTaskSmartAlertSuccessE[] = {
...
Q_CONSTINIT const QMetaObject MCustomTaskSmartAlertSuccess::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN28MCustomTaskSmartAlertSuccessE.offsetsAndSizes,
    qt_meta_data_ZN28MCustomTaskSmartAlertSuccessE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN28MCustomTaskSmartAlertSuccessE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<MCustomTaskSmartAlertSuccess *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *MCustomTaskSmartAlertSuccess::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN28MCustomTaskSmartAlertSuccessE.stringdata0))
