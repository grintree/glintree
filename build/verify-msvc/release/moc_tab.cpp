...
static constexpr auto qt_meta_stringdata_ZN3TabE = QtMocHelpers::stringData(
    "Tab",
    "onCloseTab",
    "",
    "index"
...
Q_CONSTINIT static const uint qt_meta_data_ZN3TabE[] = {
...
Q_CONSTINIT const QMetaObject Tab::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN3TabE.offsetsAndSizes,
    qt_meta_data_ZN3TabE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN3TabE_t,
        // Q_OBJECT / Q_GADGET
...
void *Tab::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN3TabE.stringdata0))
