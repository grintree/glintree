...
namespace {
struct qt_meta_tag_ZN19SettingsProxyDialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN19SettingsProxyDialogE = QtMocHelpers::stringData(
    "SettingsProxyDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN19SettingsProxyDialogE[] = {
...
Q_CONSTINIT const QMetaObject SettingsProxyDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19SettingsProxyDialogE.offsetsAndSizes,
    qt_meta_data_ZN19SettingsProxyDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19SettingsProxyDialogE_t,
        // Q_OBJECT / Q_GADGET
...
{
    auto *_t = static_cast<SettingsProxyDialog *>(_o);
    (void)_t;
    (void)_c;
    (void)_id;
    (void)_a;
...
void *SettingsProxyDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19SettingsProxyDialogE.stringdata0))
