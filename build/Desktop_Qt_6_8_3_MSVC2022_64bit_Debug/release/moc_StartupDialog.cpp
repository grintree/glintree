...
static constexpr auto qt_meta_stringdata_ZN13StartupDialogE = QtMocHelpers::stringData(
    "StartupDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13StartupDialogE[] = {
...
Q_CONSTINIT const QMetaObject StartupDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13StartupDialogE.offsetsAndSizes,
    qt_meta_data_ZN13StartupDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13StartupDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *StartupDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13StartupDialogE.stringdata0))
