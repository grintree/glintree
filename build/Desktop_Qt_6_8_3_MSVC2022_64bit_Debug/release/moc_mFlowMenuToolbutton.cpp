...
namespace {
struct qt_meta_tag_ZN19MFlowMenuToolButtonE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN19MFlowMenuToolButtonE = QtMocHelpers::stringData(
    "MFlowMenuToolButton",
...
Q_CONSTINIT static const uint qt_meta_data_ZN19MFlowMenuToolButtonE[] = {
...
Q_CONSTINIT const QMetaObject MFlowMenuToolButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19MFlowMenuToolButtonE.offsetsAndSizes,
    qt_meta_data_ZN19MFlowMenuToolButtonE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19MFlowMenuToolButtonE_t,
        // Q_OBJECT / Q_GADGET
...
void MFlowMenuToolButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MFlowMenuToolButton::*)(MFlowStepData * );
            if (_q_method_type _q_method = &MFlowMenuToolButton::notificationToParentWidget; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *MFlowMenuToolButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19MFlowMenuToolButtonE.stringdata0))
