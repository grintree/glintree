...
namespace {
struct qt_meta_tag_ZN15MFlowLoopWidgetE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN15MFlowLoopWidgetE = QtMocHelpers::stringData(
    "MFlowLoopWidget",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15MFlowLoopWidgetE[] = {
...
Q_CONSTINIT const QMetaObject MFlowLoopWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15MFlowLoopWidgetE.offsetsAndSizes,
    qt_meta_data_ZN15MFlowLoopWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15MFlowLoopWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void MFlowLoopWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MFlowLoopWidget::*)(MFlowStepData * );
            if (_q_method_type _q_method = &MFlowLoopWidget::notificationToParentWidget; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *MFlowLoopWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15MFlowLoopWidgetE.stringdata0))
