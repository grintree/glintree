...
RunMessage::RunMessage(QWidget *parent) : QDialog(parent)
{
    ...
    nameDesc->setText(tr(QString("<span style='color:rgb(134,134,139)'>任务</span>   <span style='font-size:18px;font-family:Microsoft YaHei;'>%1</span>").arg(task->name).toUtf8()));
