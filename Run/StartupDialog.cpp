...
//    rightDirectStartWidget->setStyleSheet(".QWidget{background-color:rgb(255,255,255);}");
    ...
    introLabel->setStyleSheet(".QLabel{color:rgb(29,29,31);font-family:Microsoft YaHei;font-size:19px;}");
...
//    rightDirectStartWidget->setStyleSheet(".QWidget{background-color:rgb(255,255,255);}");
  ...
  introWidget->setFixedHeight(40);
    ...
    summaryLabel->setStyleSheet(".QLabel{color:rgb(29,29,31);font-family:Microsoft YaHei;font-size:20px;}");
