    ...
    field(field),fieldIndex(fieldIndex)
{
    ...
    setWindowTitle("高级选项");
    setStyleSheet(".TaskDataMenuDialog{background-color:rgb(245,245,247);}");
...
//    threadCountSpin->setSuffix("并发");
    ...
    dirBtn->setStyleSheet( ".QPushButton {color:rgb(29,29,31);font-family:Microsoft YaHei;font-size:17px;background-color:white; border:1px solid rgb(29,29,31); padding: 0px;}\
