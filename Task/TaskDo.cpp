...
void TaskDo::initTopMenuUi(){
    ...
    tipMenu->setStyleSheet(".QMenu{color:rgb(0,0,0);font-family:Microsoft YaHei;font-size:17px;border:1px solid rgb(29,29,31);border-radius: 3px; padding: 1px;}");
...
void TaskDo::initBottomUi(){
    ...
    progressBar->setStyleSheet(QStringLiteral("QProgressBar {border: 0px;background-color: rgb(229,229,234);} QProgressBar::chunk {background-color: rgb(10,132,255);}"));
