...
void TaskManage::initTableUi(){
    ...
    tableWidget->setStyleSheet("QTableWidget{color:rgb(29,29,31);font-family:Microsoft YaHei UI;font-size:17px;background:rgb(255,255,255);alternate-background-color:rgb(245,245,247);gridline-color:rgb(242,242,247);border:1px solid rgb(229,229,234);border-radius:8px;}\
       QTableWidget::item{margin-left:10px;}\
       QTableWidget::item:selected{color:rgb(29,29,31);background:rgba(10,132,255,0.15);}\
       QTableWidget::item:hover{background:rgba(10,132,255,0.06);}\
       QHeaderView::section{text-align:center;background:rgb(245,245,247);color:rgb(134,134,139);padding:8px;border:none;border-bottom:1px solid rgb(229,229,234);}\
