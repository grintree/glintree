...
void TaskData::initTableUi(){
    ...
    tableWidget->setStyleSheet(".QTableWidget{border:1px solid rgb(209,209,214); border-radius: 0px;padding: 1px;}");
...
void TaskData::initBottomUi(){
    ...
    logListWidget->setStyleSheet(".QListWidget{border:1px solid rgb(209,209,214); border-radius: 0px;padding: 2px;}");
