...
Tab::Tab(QWidget *parent) : QTabWidget(parent)
{
    ...
    QString style =  "QTabWidget::pane{background:transparent;border:none;} \
              QTabBar::tab {color:rgb(134,134,139);font-family:Microsoft YaHei UI;font-size:17px;min-width:90px;height:28px;padding:0px 12px;border-radius:8px;margin:6px 2px;} \
              QTabBar::tab:!selected {background:transparent;border:none;} \
              QTabBar::tab:hover{background:rgba(0,0,0,0.06);} \
              QTabBar::tab:selected  {background:rgb(232,232,237);color:rgb(29,29,31);font-weight:600;}";
