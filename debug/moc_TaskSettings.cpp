...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSTaskSettingsENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSTaskSettingsENDCLASS_t qt_meta_stringdata_CLASSTaskSettingsENDCLASS = {
    {
        QT_MOC_LITERAL(0, 12),  // "TaskSettings"
        QT_MOC_LITERAL(13, 10),  // "notifyBack"
        QT_MOC_LITERAL(24, 0)   // ""
    },
    "TaskSettings",
    "notifyBack",
...
void TaskSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TaskSettings::*)();
            if (_t _q_method = &TaskSettings::notifyBack; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
